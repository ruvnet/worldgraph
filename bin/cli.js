...
// Generated by metaharness — the `worldgraph` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx worldgraph`
...
// "bin" + "files" fields in package.json), so `npx worldgraph` works the moment
